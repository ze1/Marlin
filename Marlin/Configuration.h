...
#define MACHINE_UUID   "20180817-0333-0185-003D-0000000000AE"
...
/**
   PrР•Р‡Р•РЋa MK2 Single Nozzle Multi-Material Multiplexer, and variants.
...
/**
   ...
   Temperature sensors available:
      ...
      13 : 100k Hisens 3950  1% up to 300Р’В°C for hotend "Simple ONE " & "Hotend "All In ONE"
    ...
    1010 : Pt1000 with 1k pullup (non standard)
     ...
     998 : Dummy Table that ALWAYS reads 25Р’В°C or the temperature defined below.
     999 : Dummy Table that ALWAYS reads 100Р’В°C or the temperature defined below.

   :{ '0': "Not used", '1':"100k / 4.7k - EPCOS", '2':"200k / 4.7k - ATC Semitec 204GT-2", '3':"Mendel-parts / 4.7k", '4':"10k !! do not use for a hotend. Bad resolution at high temp. !!", '5':"100K / 4.7k - ATC Semitec 104GT-2 (Used in ParCan & J-Head)", '6':"100k / 4.7k EPCOS - Not as accurate as Table 1", '7':"100k / 4.7k Honeywell 135-104LAG-J01", '8':"100k / 4.7k 0603 SMD Vishay NTCS0603E3104FXT", '9':"100k / 4.7k GE Sensing AL03006-58.2K-97-G1", '10':"100k / 4.7k RS 198-961", '11':"100k / 4.7k beta 3950 1%", '12':"100k / 4.7k 0603 SMD Vishay NTCS0603E3104FXT (calibrated for Makibox hot bed)", '13':"100k Hisens 3950  1% up to 300Р’В°C for hotend 'Simple ONE ' & hotend 'All In ONE'", '20':"PT100 (Ultimainboard V2.x)", '51':"100k / 1k - EPCOS", '52':"200k / 1k - ATC Semitec 204GT-2", '55':"100k / 1k - ATC Semitec 104GT-2 (Used in ParCan & J-Head)", '60':"100k Maker's Tool Works Kapton Bed Thermistor beta=3950", '66':"Dyze Design 4.7M High Temperature thermistor", '70':"the 100K thermistor found in the bq Hephestos 2", '71':"100k / 4.7k Honeywell 135-104LAF-J01", '147':"Pt100 / 4.7k", '1047':"Pt1000 / 4.7k", '110':"Pt100 / 1k (non-standard)", '1010':"Pt1000 / 1k (non standard)", '-3':"Thermocouple + MAX31855 (only for sensor 0)", '-2':"Thermocouple + MAX6675 (only for sensor 0)", '-1':"Thermocouple + AD595",'998':"Dummy 1", '999':"Dummy 2" }
*/
...
/**
     ...
     #define Y_PROBE_OFFSET_FROM_EXTRUDER 10
                  ...
                  Y offset:
                    ...
                    +2       
                    +1
  X offset: -3 -2 -1 0 +1 +2 +3  <-- nozzle (X offset = 0; Y offset = 0)
                    -1       
     Y              -2        P  <-- probe (X offset = 3; Y offset = -2)
     |              -3     
     +---X  
**/
...
#define Z_PROBE_SPEED_SLOW (Z_PROBE_SPEED_FAST / 1.618)
...
#define MESH_TEST_HOTEND_TEMP   205.0   // (Р’В°C) Default nozzle temperature for the G26 Mesh Validation Tool.
#define MESH_TEST_BED_TEMP       60.0   // (Р’В°C) Default bed temperature for the G26 Mesh Validation Tool.
#endif
...
*/
//#define Z_PROBE_END_SCRIPT "G1 Z20 F12000\nG1 X15 Y330\nG1 Z0.5\nG1 Z10"
...
#define Z_SAFE_HOMING_X_POINT 35       //((X_BED_SIZE) / 2)    // X point for Z homing when homing all axes (G28).
#define Z_SAFE_HOMING_Y_POINT 160      //((Y_BED_SIZE) / 2)    // Y point for Z homing when homing all axes (G28).
...
// Homing speeds (mm/m)
#define HOMING_FEEDRATE_XY (41.42 * 60)   // (50 * 60)
#define HOMING_FEEDRATE_Z  (4.142 * 60)   // (4 * 60)
...
//
//#define ENCODER_STEPS_PER_MENU_ITEM 6
...
//
// MKS OLED 1.3" 128 Р“вЂ” 64 FULL GRAPHICS CONTROLLER
